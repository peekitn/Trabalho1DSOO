class ControladorAtendimento:
    def __init__(self, view: TelaAtendimento):
        self.__view = view
    ...
    def _validar_horario_clinica(self, horario_inicio: str):
        #As clínicas funcionam das 08:00 às 18:00 
    ...
    def processar_pagamento(self, atendimento: Atendimento):
        try:
            ...
            # A própria entidade Atendimento realiza a validação da data
